...
var Treemap = (function (_super) {
    ...
    Treemap.getDerivedStateFromProps = function (nextProps, prevState) {
        if (nextProps.data !== prevState.prevData ||
            ...
            return __assign(__assign({}, prevState), { formatRoot: formatRoot, currentRoot: root, nestIndex: [root], prevAspectRatio: nextProps.aspectRatio, prevData: nextProps.data, prevWidth: nextProps.width, prevHeight: nextProps.height, prevDataKey: nextProps.dataKey, prevType: nextProps.type });
        }
        return null;
    };
    ...
    Treemap.prototype.renderItem = function (content, nodeProps, isLeaf) {
        ...
        if (!isAnimationActive) {
            return (react_1.default.createElement(Layer_1.Layer, __assign({}, event), this.constructor.renderContentItem(content, __assign(__assign({}, nodeProps), { isAnimationActive: false, isUpdateAnimationActive: false, width: width, height: height, x: x, y: y }), type, colorPanel)));
        }
        return (react_1.default.createElement(react_smooth_1.default, { begin: animationBegin, duration: animationDuration, isActive: isAnimationActive, easing: animationEasing, key: "treemap-".concat(animationId), from: { x: x, y: y, width: width, height: height }, to: { x: x, y: y, width: width, height: height }, onAnimationStart: this.handleAnimationStart, onAnimationEnd: this.handleAnimationEnd }, function (_a) {
            var currX = _a.x, currY = _a.y, currWidth = _a.width, currHeight = _a.height;
            return (react_1.default.createElement(react_smooth_1.default, { from: "translate(".concat(translateX, "px, ").concat(translateX, "px)"), to: "translate(0, 0)", attributeName: "transform", begin: animationBegin, easing: animationEasing, isActive: isAnimationActive, duration: animationDuration },
    ...
    Treemap.renderContentItem = function (content, nodeProps, type, colorPanel) {
        ...
        var text = null;
        var nameSize = (0, DOMUtils_1.getStringSize)(nodeProps.name);
        ...
        return (react_1.default.createElement("g", null,
            react_1.default.createElement(Rectangle_1.Rectangle, __assign({ fill: nodeProps.depth < 2 ? colors[index % colors.length] : 'rgba(255,255,255,0)', stroke: "#fff" }, lodash_1.default.omit(nodeProps, 'children'), { role: "img" })),
            arrow,
            text));
    };
    Treemap.prototype.renderNode = function (root, node, i) {
        ...
        var nodeProps = __assign(__assign(__assign({}, (0, types_1.filterProps)(this.props)), node), { root: root });
        ...
        return (react_1.default.createElement(Layer_1.Layer, { key: "recharts-treemap-node-".concat(i), className: "recharts-treemap-depth-".concat(node.depth) },
    ...
    Treemap.prototype.renderNestIndex = function () {
        ...
        return (react_1.default.createElement("div", { className: "recharts-treemap-nest-index-wrapper", style: { marginTop: '8px', textAlign: 'center' } }, nestIndex.map(function (item, i) {
            ...
            return (react_1.default.createElement("div", { onClick: _this.handleNestIndex.bind(_this, item, i), key: "nest-index-".concat((0, DataUtils_1.uniqueId)()), className: "recharts-treemap-nest-index-box", style: {
                    cursor: 'pointer',
    ...
    Treemap.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)('recharts-wrapper', className), style: __assign(__assign({}, style), { position: 'relative', cursor: 'default', width: width, height: height }), role: "region" },
            react_1.default.createElement(Surface_1.Surface, __assign({}, attrs, { width: width, height: type === 'nest' ? height - 30 : height }),
                this.renderAllNodes(),
                (0, ReactUtils_1.filterSvgElements)(children)),
            this.renderTooltip(),
