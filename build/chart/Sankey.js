...
var getPayloadOfTooltip = function (el, type, nameKey) {
    ...
    if (payload.source && payload.target) {
        var sourceName = (0, ChartUtils_1.getValueByDataKey)(payload.source, nameKey, '');
        var targetName = (0, ChartUtils_1.getValueByDataKey)(payload.target, nameKey, '');
        return [
            {
                payload: el,
...
var Sankey = (function (_super) {
    ...
    Sankey.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (data !== prevState.prevData ||
            ...
            return __assign(__assign({}, prevState), { nodes: nodes, links: links, prevData: data, prevWidth: iterations, prevHeight: height, prevMargin: margin, prevNodePadding: nodePadding, prevNodeWidth: nodeWidth, prevIterations: iterations });
        }
        return null;
    };
        ...
        if (tooltipItem) {
            this.setState(function (prev) {
                if (tooltipItem.props.trigger === 'hover') {
                    return __assign(__assign({}, prev), { activeElement: el, activeElementType: type, isTooltipActive: true });
                }
                return prev;
            }, function () {
                if (onMouseEnter) {
    ...
    Sankey.prototype.handleMouseLeave = function (el, type, e) {
        ...
        if (tooltipItem) {
            this.setState(function (prev) {
                if (tooltipItem.props.trigger === 'hover') {
                    return __assign(__assign({}, prev), { activeElement: undefined, activeElementType: undefined, isTooltipActive: false });
                }
                return prev;
            }, function () {
                if (onMouseLeave) {
    ...
    Sankey.prototype.renderLinks = function (links, nodes) {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { className: "recharts-sankey-links", key: "recharts-sankey-links" }, links.map(function (link, i) {
            ...
            var linkProps = __assign({ sourceX: sourceX, targetX: targetX, sourceY: sourceY, targetY: targetY, sourceControlX: sourceControlX, targetControlX: targetControlX, sourceRelativeY: sourceRelativeY, targetRelativeY: targetRelativeY, linkWidth: linkWidth, index: i, payload: __assign(__assign({}, link), { source: source, target: target }) }, (0, types_1.filterProps)(linkContent));
            var events = {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ key: "link".concat(i) }, events), _this.constructor.renderLinkItem(linkContent, linkProps)));
        })));
    };
    Sankey.renderNodeItem = function (option, props) {
        ...
        return (react_1.default.createElement(Rectangle_1.Rectangle, __assign({ className: "recharts-sankey-node", fill: "#0088fe", fillOpacity: "0.8" }, (0, types_1.filterProps)(props), { role: "img" })));
    };
    Sankey.prototype.renderNodes = function (nodes) {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { className: "recharts-sankey-nodes", key: "recharts-sankey-nodes" }, nodes.map(function (node, i) {
            ...
            var nodeProps = __assign(__assign({}, (0, types_1.filterProps)(nodeContent)), { x: x + left, y: y + top, width: dx, height: dy, index: i, payload: node });
            var events = {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ key: "node".concat(i) }, events), _this.constructor.renderNodeItem(nodeContent, nodeProps)));
        })));
    };
