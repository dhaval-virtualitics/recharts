...
var getActiveCoordinate = function (layout, tooltipTicks, activeIndex, rangeObj) {
    ...
    if (entry) {
        ...
        if (layout === 'centric') {
            ...
            return __assign(__assign(__assign({}, rangeObj), (0, PolarUtils_1.polarToCartesian)(rangeObj.cx, rangeObj.cy, radius_1, angle_1)), { angle: angle_1, radius: radius_1 });
        }
        var radius = entry.coordinate;
        var angle = rangeObj.angle;
        return __assign(__assign(__assign({}, rangeObj), (0, PolarUtils_1.polarToCartesian)(rangeObj.cx, rangeObj.cy, radius, angle)), { angle: angle, radius: radius });
    }
...
var getDisplayedData = function (data, _a, item) {
    ...
    var itemsData = (graphicalItems || []).reduce(function (result, child) {
        ...
        if (itemData && itemData.length) {
            return __spreadArray(__spreadArray([], result, true), itemData, true);
        }
        return result;
    }, []);
...
var getTooltipData = function (state, chartData, layout, rangeObj) {
    ...
    var activeIndex = (0, ChartUtils_1.calculateActiveTickIndex)(pos, ticks, tooltipTicks, axis);
...
var getAxisMapByAxes = function (props, _a) {
    ...
    var isCategorical = (0, ChartUtils_1.isCategoricalAxis)(layout, axisType);
        ...
        if (!result[axisId]) {
            ...
            if (dataKey) {
                ...
                if (type === 'category' && isCategorical) {
                    var duplicate = (0, DataUtils_1.hasDuplicate)(domain);
                    if (allowDuplicatedCategory && duplicate) {
                        duplicateDomain = domain;
                        domain = lodash_1.default.range(0, len);
                    }
                    else if (!allowDuplicatedCategory) {
                        domain = (0, ChartUtils_1.parseDomainOfCategoryAxis)(child.props.domain, domain, child).reduce(function (finalDomain, entry) {
                            return finalDomain.indexOf(entry) >= 0 ? finalDomain : __spreadArray(__spreadArray([], finalDomain, true), [entry], false);
                        }, []);
                    }
                }
                    ...
                    if (!allowDuplicatedCategory) {
                        domain = (0, ChartUtils_1.parseDomainOfCategoryAxis)(child.props.domain, domain, child).reduce(function (finalDomain, entry) {
                            return finalDomain.indexOf(entry) >= 0 || entry === '' || lodash_1.default.isNil(entry)
                                ? finalDomain
                                : __spreadArray(__spreadArray([], finalDomain, true), [entry], false);
                        }, []);
                    }
                    else {
                    ...
                    var errorBarsDomain = (0, ChartUtils_1.parseErrorBarsOfAxis)(displayedData, graphicalItems.filter(function (item) { return item.props[axisIdKey] === axisId && !item.props.hide; }), dataKey, axisType, layout);
                    if (errorBarsDomain) {
                ...
                domain = (0, ChartUtils_1.getDomainOfItemsWithSameAxis)(displayedData, graphicalItems.filter(function (item) { return item.props[axisIdKey] === axisId && !item.props.hide; }), type, layout, true);
            }
            if (type === 'number') {
                domain = (0, DetectReferenceElementsDomain_1.detectReferenceElementsDomain)(children, domain, axisId, axisType, ticks);
                if (child.props.domain) {
                    domain = (0, ChartUtils_1.parseSpecifiedDomain)(child.props.domain, domain, allowDataOverflow);
                }
            }
            ...
            return __assign(__assign({}, result), (_a = {}, _a[axisId] = __assign(__assign({}, child.props), { axisType: axisType, domain: domain, categoricalDomain: categoricalDomain, duplicateDomain: duplicateDomain, originalDomain: child.props.domain, isCategorical: isCategorical, layout: layout }), _a));
        }
        return result;
    }, {});
    return axisMap;
    ...
    var axisMap = graphicalItems.reduce(function (result, child) {
        ...
        if (!result[axisId]) {
            ...
            if (isCategorical) {
                ...
                domain = (0, ChartUtils_1.parseSpecifiedDomain)(Axis.defaultProps.domain, (0, ChartUtils_1.getDomainOfItemsWithSameAxis)(displayedData, graphicalItems.filter(function (item) { return item.props[axisIdKey] === axisId && !item.props.hide; }), 'number', layout), Axis.defaultProps.allowDataOverflow);
                domain = (0, DetectReferenceElementsDomain_1.detectReferenceElementsDomain)(children, domain, axisId, axisType);
            }
            return __assign(__assign({}, result), (_a = {}, _a[axisId] = __assign(__assign({ axisType: axisType }, Axis.defaultProps), { hide: true, orientation: lodash_1.default.get(ORIENT_MAP, "".concat(axisType, ".").concat(index % 2), null), domain: domain, originalDomain: Axis.defaultProps.domain, isCategorical: isCategorical, layout: layout }), _a));
        }
        return result;
    }, {});
    return axisMap;
...
var getAxisMap = function (props, _a) {
    ...
    var axes = (0, ReactUtils_1.findAllByType)(children, AxisComp);
    var axisMap = {};
    if (axes && axes.length) {
...
var tooltipTicksGenerator = function (axisMap) {
    var axis = (0, DataUtils_1.getAnyElementOfObject)(axisMap);
    var tooltipTicks = (0, ChartUtils_1.getTicksOfAxis)(axis, false, true);
    return {
...
var createDefaultState = function (props) {
    ...
    var brushItem = (0, ReactUtils_1.findChildByType)(children, Brush_1.Brush.displayName);
    var startIndex = (brushItem && brushItem.props && brushItem.props.startIndex) || 0;
    var endIndex = ((_a = brushItem === null || brushItem === void 0 ? void 0 : brushItem.props) === null || _a === void 0 ? void 0 : _a.endIndex) !== undefined ? (_b = brushItem === null || brushItem === void 0 ? void 0 : brushItem.props) === null || _b === void 0 ? void 0 : _b.endIndex : (props.data && props.data.length - 1) || 0;
    return {
        chartX: 0,
        chartY: 0,
...
var hasGraphicalBarItem = function (graphicalItems) {
    ...
    return graphicalItems.some(function (item) {
        var name = (0, ReactUtils_1.getDisplayName)(item && item.type);
...
var calculateOffset = function (_a, prevLegendBBox) {
    ...
    var brushItem = (0, ReactUtils_1.findChildByType)(children, Brush_1.Brush.displayName);
    var legendItem = (0, ReactUtils_1.findChildByType)(children, Legend_1.Legend.displayName);
    ...
    var offsetV = Object.keys(xAxisMap).reduce(function (result, id) {
        ...
        var orientation = entry.orientation;
        if (!entry.mirror && !entry.hide) {
            return __assign(__assign({}, result), (_a = {}, _a[orientation] = lodash_1.default.get(result, "".concat(orientation)) + entry.height, _a));
        }
        return result;
    ...
    if (legendItem && prevLegendBBox) {
        offset = (0, ChartUtils_1.appendOffsetOfLegend)(offset, graphicalItems, props, prevLegendBBox);
    }
...
var generateCategoricalChart = function (_a) {
    ...
    var getFormatItems = function (props, currentState) {
        ...
        var sizeList = hasBar && (0, ChartUtils_1.getBarSizeList)({ barSize: barSize, stackGroups: stackGroups });
        var formattedItems = [];
        graphicalItems.forEach(function (item, index) {
            var _a;
            var _b, _c;
            var displayedData = getDisplayedData(props.data, { dataStartIndex: dataStartIndex, dataEndIndex: dataEndIndex }, item);
            var _d = item.props, dataKey = _d.dataKey, childMaxBarSize = _d.maxBarSize;
            ...
            var axisObj = axisComponents.reduce(function (result, entry) {
                ...
                return __assign(__assign({}, result), (_a = {}, _a[entry.axisType] = axis, _a["".concat(entry.axisType, "Ticks")] = (0, ChartUtils_1.getTicksOfAxis)(axis), _a));
            }, {});
            ...
            var itemIsBar = (0, ReactUtils_1.getDisplayName)(item.type).indexOf('Bar') >= 0;
            var bandSize = (0, ChartUtils_1.getBandSizeOfAxis)(cateAxis, cateTicks);
            var barPosition = [];
            if (itemIsBar) {
                var maxBarSize = lodash_1.default.isNil(childMaxBarSize) ? globalMaxBarSize : childMaxBarSize;
                var barBandSize_1 = (_c = (_b = (0, ChartUtils_1.getBandSizeOfAxis)(cateAxis, cateTicks, true)) !== null && _b !== void 0 ? _b : maxBarSize) !== null && _c !== void 0 ? _c : 0;
            ...
            if (composedFn) {
                formattedItems.push({
                    props: __assign(__assign({}, composedFn(__assign(__assign({}, axisObj), { displayedData: displayedData, props: props, dataKey: dataKey, item: item, bandSize: bandSize, barPosition: barPosition, offset: offset, stackedData: stackedData, layout: layout, dataStartIndex: dataStartIndex, dataEndIndex: dataEndIndex }))), (_a = { key: item.key || "item-".concat(index) }, _a[numericAxisName] = axisObj[numericAxisName], _a[cateAxisName] = axisObj[cateAxisName], _a.animationId = updateId, _a)),
    ...
    var updateStateOfAxisMapsOffsetAndStackGroups = function (_a, prevState) {
        ...
        if (!(0, ReactUtils_1.validateWidthHeight)({ props: props })) {
            return null;
        }
        ...
        var graphicalItems = (0, ReactUtils_1.findAllByType)(children, GraphicalChild);
        var stackGroups = (0, ChartUtils_1.getStackGroupsByAxisId)(data, graphicalItems, "".concat(numericAxisName, "Id"), "".concat(cateAxisName, "Id"), stackOffset, reverseStackOrder);
        var axisObj = axisComponents.reduce(function (result, entry) {
            var _a;
            var name = "".concat(entry.axisType, "Map");
            return __assign(__assign({}, result), (_a = {}, _a[name] = getAxisMap(props, __assign(__assign({}, entry), { graphicalItems: graphicalItems, stackGroups: entry.axisType === numericAxisName && stackGroups, dataStartIndex: dataStartIndex, dataEndIndex: dataEndIndex })), _a));
        }, {});
        ...
        var formattedGraphicalItems = getFormatItems(props, __assign(__assign({}, axisObj), { dataStartIndex: dataStartIndex, dataEndIndex: dataEndIndex, updateId: updateId, graphicalItems: graphicalItems, stackGroups: stackGroups, offset: offset }));
        return __assign(__assign({ formattedGraphicalItems: formattedGraphicalItems, graphicalItems: graphicalItems, offset: offset, stackGroups: stackGroups }, ticksObj), axisObj);
    };
    return _b = (function (_super) {
            ...
            function CategoricalChartWrapper(props) {
                ...
                _this.clearDeferId = function () {
                    if (!(0, lodash_1.isNil)(_this.deferId) && deferClear) {
                ...
                _this.handleOuterEvent = function (e) {
                    var eventName = (0, ReactUtils_1.getReactEventByType)(e);
                    var event = lodash_1.default.get(_this.props, "".concat(eventName));
                ...
                _this.verticalCoordinatesGenerator = function (_a) {
                    ...
                    return (0, ChartUtils_1.getCoordinatesOfGrid)(CartesianAxis_1.CartesianAxis.getTicks(__assign(__assign(__assign({}, CartesianAxis_1.CartesianAxis.defaultProps), xAxis), { ticks: (0, ChartUtils_1.getTicksOfAxis)(xAxis, true), viewBox: { x: 0, y: 0, width: width, height: height } })), offset.left, offset.left + offset.width);
                };
                _this.horizontalCoordinatesGenerator = function (_a) {
                    var yAxis = _a.yAxis, width = _a.width, height = _a.height, offset = _a.offset;
                    return (0, ChartUtils_1.getCoordinatesOfGrid)(CartesianAxis_1.CartesianAxis.getTicks(__assign(__assign(__assign({}, CartesianAxis_1.CartesianAxis.defaultProps), yAxis), { ticks: (0, ChartUtils_1.getTicksOfAxis)(yAxis, true), viewBox: { x: 0, y: 0, width: width, height: height } })), offset.top, offset.top + offset.height);
                };
                _this.axesTicksGenerator = function (axis) { return (0, ChartUtils_1.getTicksOfAxis)(axis, true); };
                _this.renderCursor = function (element) {
                    ...
                    var cursorProps = __assign(__assign(__assign(__assign({ stroke: '#ccc', pointerEvents: 'none' }, offset), restProps), (0, types_1.filterProps)(element.props.cursor)), { payload: activePayload, payloadIndex: activeTooltipIndex, key: key, className: 'recharts-tooltip-cursor' });
                ...
                _this.renderPolarAxis = function (element, displayName, index) {
                    ...
                    var axisMap = lodash_1.default.get(_this.state, "".concat(axisType, "Map"));
                    var axisOption = axisMap && axisMap[element.props["".concat(axisType, "Id")]];
                    return (0, react_1.cloneElement)(element, __assign(__assign({}, axisOption), { className: axisType, key: element.key || "".concat(displayName, "-").concat(index), ticks: (0, ChartUtils_1.getTicksOfAxis)(axisOption, true) }));
                };
                ...
                _this.renderPolarGrid = function (element) {
                    ...
                    var radiusAxis = (0, DataUtils_1.getAnyElementOfObject)(radiusAxisMap);
                    var angleAxis = (0, DataUtils_1.getAnyElementOfObject)(angleAxisMap);
                    var cx = angleAxis.cx, cy = angleAxis.cy, innerRadius = angleAxis.innerRadius, outerRadius = angleAxis.outerRadius;
                    return (0, react_1.cloneElement)(element, {
                        polarAngles: (0, lodash_1.isArray)(polarAngles)
                            ? polarAngles
                            : (0, ChartUtils_1.getTicksOfAxis)(angleAxis, true).map(function (entry) { return entry.coordinate; }),
                        polarRadius: (0, lodash_1.isArray)(polarRadius)
                            ? polarRadius
                            : (0, ChartUtils_1.getTicksOfAxis)(radiusAxis, true).map(function (entry) { return entry.coordinate; }),
                        cx: cx,
                        cy: cy,
                ...
                _this.renderLegend = function () {
                    ...
                    var props = (0, ChartUtils_1.getLegendProps)({
                        children: children,
                    ...
                    return (0, react_1.cloneElement)(item, __assign(__assign({}, otherProps), { chartWidth: width, chartHeight: height, margin: margin, ref: function (legend) {
                            _this.legendInstance = legend;
                        }, onBBoxUpdate: _this.handleLegendBBoxUpdate }));
                };
                _this.renderTooltip = function () {
                    var children = _this.props.children;
                    var tooltipItem = (0, ReactUtils_1.findChildByType)(children, Tooltip_1.Tooltip.displayName);
                    if (!tooltipItem) {
                        return null;
                    }
                ...
                _this.renderBrush = function (element) {
                    ...
                    return (0, react_1.cloneElement)(element, {
                        ...
                        onChange: (0, ChartUtils_1.combineEventHandlers)(_this.handleBrushChange, null, element.props.onChange),
                        data: data,
                        x: (0, DataUtils_1.isNumber)(element.props.x) ? element.props.x : offset.left,
                        y: (0, DataUtils_1.isNumber)(element.props.y)
                            ? element.props.y
                            : offset.top + offset.height + offset.brushBottom - (margin.bottom || 0),
                        width: (0, DataUtils_1.isNumber)(element.props.width) ? element.props.width : offset.width,
                ...
                _this.renderActivePoints = function (_a) {
                    ...
                    var dotProps = __assign(__assign({ index: childIndex, dataKey: dataKey, cx: activePoint.x, cy: activePoint.y, r: 4, fill: (0, ChartUtils_1.getMainColorOfGraphicItem)(item.item), strokeWidth: 2, stroke: '#fff', payload: activePoint.payload, value: activePoint.value, key: "".concat(key, "-activePoint-").concat(childIndex) }, (0, types_1.filterProps)(activeDot)), (0, types_1.adaptEventHandlers)(activeDot));
                    result.push(CategoricalChartWrapper.renderActiveDot(activeDot, dotProps));
                    if (basePoint) {
                        result.push(CategoricalChartWrapper.renderActiveDot(activeDot, __assign(__assign({}, dotProps), { cx: basePoint.x, cy: basePoint.y, key: "".concat(key, "-basePoint-").concat(childIndex) })));
                    }
                    else if (isRange) {
                        result.push(null);
                    }
                ...
                _this.renderGraphicChild = function (element, displayName, index) {
                    ...
                    if (tooltipEventType !== 'axis' && tooltipItem && tooltipItem.props.trigger === 'click') {
                        itemEvents = {
                            onClick: (0, ChartUtils_1.combineEventHandlers)(_this.handleItemMouseEnter, null, element.props.onCLick),
                        };
                    }
                    else if (tooltipEventType !== 'axis') {
                        itemEvents = {
                            onMouseLeave: (0, ChartUtils_1.combineEventHandlers)(_this.handleItemMouseLeave, null, element.props.onMouseLeave),
                            onMouseEnter: (0, ChartUtils_1.combineEventHandlers)(_this.handleItemMouseEnter, null, element.props.onMouseEnter),
                        };
                    }
                    var graphicalItem = (0, react_1.cloneElement)(element, __assign(__assign({}, item.props), itemEvents));
                ...
                _this.renderCustomized = function (element, displayName, index) {
                    return (0, react_1.cloneElement)(element, __assign(__assign({ key: "recharts-customized-".concat(index) }, _this.props), _this.state));
                };
                _this.uniqueChartId = lodash_1.default.isNil(props.id) ? (0, DataUtils_1.uniqueId)('recharts') : props.id;
            ...
            CategoricalChartWrapper.prototype.getTooltipEventType = function () {
                var tooltipItem = (0, ReactUtils_1.findChildByType)(this.props.children, Tooltip_1.Tooltip.displayName);
                if (tooltipItem && (0, lodash_1.isBoolean)(tooltipItem.props.shared)) {
            ...
            CategoricalChartWrapper.prototype.getMouseInfo = function (event) {
                ...
                var containerOffset = (0, DOMUtils_1.getOffset)(this.container);
                var e = (0, DOMUtils_1.calculateChartCoordinate)(event, containerOffset);
                ...
                if (tooltipEventType !== 'axis' && xAxisMap && yAxisMap) {
                    var xScale = (0, DataUtils_1.getAnyElementOfObject)(xAxisMap).scale;
                    var yScale = (0, DataUtils_1.getAnyElementOfObject)(yAxisMap).scale;
            ...
            CategoricalChartWrapper.prototype.getCursorPoints = function () {
                ...
                if (layout === 'horizontal') {
                    ...
                    if (layout === 'centric') {
                        ...
                        var innerPoint = (0, PolarUtils_1.polarToCartesian)(cx, cy, innerRadius, angle);
                        var outerPoint = (0, PolarUtils_1.polarToCartesian)(cx, cy, outerRadius, angle);
                        x1 = innerPoint.x;
                        y1 = innerPoint.y;
                        x2 = outerPoint.x;
                        y2 = outerPoint.y;
                        ...
                        var startPoint = (0, PolarUtils_1.polarToCartesian)(cx, cy, radius, startAngle);
                        var endPoint = (0, PolarUtils_1.polarToCartesian)(cx, cy, radius, endAngle);
                        return {
            ...
            CategoricalChartWrapper.prototype.inRange = function (x, y) {
                ...
                if (angleAxisMap && radiusAxisMap) {
                    var angleAxis = (0, DataUtils_1.getAnyElementOfObject)(angleAxisMap);
                    return (0, PolarUtils_1.inRangeOfSector)({ x: x, y: y }, angleAxis);
                }
                return null;
            };
            CategoricalChartWrapper.prototype.parseEventsOfWrapper = function () {
                ...
                var outerEvents = (0, types_1.adaptEventHandlers)(this.props, this.handleOuterEvent);
            ...
            CategoricalChartWrapper.prototype.applySyncEvent = function (data) {
                ...
                if (!lodash_1.default.isNil(data.dataStartIndex) || !lodash_1.default.isNil(data.dataEndIndex)) {
                    this.setState(__assign({ dataStartIndex: dataStartIndex, dataEndIndex: dataEndIndex }, updateStateOfAxisMapsOffsetAndStackGroups({
                        props: this.props,
                        dataStartIndex: dataStartIndex,
                        dataEndIndex: dataEndIndex,
                        updateId: updateId,
                    ...
                    var activeCoordinate = tooltipTicks[activeTooltipIndex]
                        ...
                        : originCoordinate;
                    this.setState(__assign(__assign({}, data), { activeLabel: activeLabel, activeCoordinate: activeCoordinate, activePayload: activePayload, activeTooltipIndex: activeTooltipIndex }));
                }
                else {
                    this.setState(data);
                }
            ...
            CategoricalChartWrapper.prototype.renderAxis = function (axisOptions, element, displayName, index) {
                ...
                return (react_1.default.createElement(CartesianAxis_1.CartesianAxis, __assign({}, axisOptions, { className: "recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), key: element.key || "".concat(displayName, "-").concat(index), viewBox: { x: 0, y: 0, width: width, height: height }, ticksGenerator: this.axesTicksGenerator })));
            };
            ...
            CategoricalChartWrapper.prototype.getXScales = function () {
                ...
                return xAxisMap
                    ? Object.entries(xAxisMap).reduce(function (res, _a) {
                        var _b;
            ...
            CategoricalChartWrapper.prototype.getYScales = function () {
                ...
                return yAxisMap
                    ? Object.entries(yAxisMap).reduce(function (res, _a) {
                        var _b;
                        var axisId = _a[0], axisProps = _a[1];
                        return __assign(__assign({}, res), (_b = {}, _b[axisId] = axisProps.scale, _b));
                    }, {})
            ...
            CategoricalChartWrapper.prototype.getItemByXY = function (chartXY) {
                ...
                if (formattedGraphicalItems && formattedGraphicalItems.length) {
                    for (var i = 0, len = formattedGraphicalItems.length; i < len; i++) {
                        ...
                        var itemDisplayName = (0, ReactUtils_1.getDisplayName)(item.type);
            ...
            CategoricalChartWrapper.prototype.render = function () {
                ...
                var _a = this.props, children = _a.children, className = _a.className, width = _a.width, height = _a.height, style = _a.style, compact = _a.compact, title = _a.title, desc = _a.desc, others = __rest(_a, ["children", "className", "width", "height", "style", "compact", "title", "desc"]);
                var attrs = (0, types_1.filterProps)(others);
                var map = {
                ...
                if (compact) {
                    return (react_1.default.createElement(Surface_1.Surface, __assign({}, attrs, { width: width, height: height, title: title, desc: desc }),
                        this.renderClipPath(),
                        (0, ReactUtils_1.renderByOrder)(children, map)));
                }
                var events = this.parseEventsOfWrapper();
                return (react_1.default.createElement("div", __assign({ className: (0, classnames_1.default)('recharts-wrapper', className), style: __assign({ position: 'relative', cursor: 'default', width: width, height: height }, style) }, events, { ref: function (node) {
                        _this.container = node;
                    }, role: "region" }),
                    react_1.default.createElement(Surface_1.Surface, __assign({}, attrs, { width: width, height: height, title: title, desc: desc }),
                        this.renderClipPath(),
                        (0, ReactUtils_1.renderByOrder)(children, map)),
                    this.renderLegend(),
                    this.renderTooltip()));
