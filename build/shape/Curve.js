...
var getCurveFactory = function (type, layout) {
    ...
    var name = "curve".concat(lodash_1.default.upperFirst(type));
...
var Curve = (function (_super) {
    ...
    Curve.prototype.render = function () {
        ...
        return (react_1.default.createElement("path", __assign({}, (0, types_1.filterProps)(this.props), (0, types_1.adaptEventHandlers)(this.props), { className: (0, classnames_1.default)('recharts-curve', className), d: realPath, ref: pathRef })));
    };
    Curve.defaultProps = {
        type: 'linear',
        points: [],
