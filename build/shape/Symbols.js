...
var getSymbolFactory = function (type) {
    var name = "symbol".concat(lodash_1.default.upperFirst(type));
...
var Symbols = (function (_super) {
    ...
    Symbols.prototype.getPath = function () {
        ...
        var symbol = (0, d3_shape_1.symbol)().type(symbolFactory).size(calculateAreaSize(size, sizeType, type));
        return symbol();
    };
    Symbols.prototype.render = function () {
        var _a = this.props, className = _a.className, cx = _a.cx, cy = _a.cy, size = _a.size;
        if (cx === +cx && cy === +cy && size === +size) {
            var filteredProps = (0, types_1.filterProps)(this.props, true);
            delete filteredProps.points;
            return (react_1.default.createElement("path", __assign({}, filteredProps, { className: (0, classnames_1.default)('recharts-symbols', className), transform: "translate(".concat(cx, ", ").concat(cy, ")"), d: this.getPath() })));
        }
        return null;
    };
    ...
    Symbols.registerSymbol = function (key, factory) {
        symbolFactories["symbol".concat(lodash_1.default.upperFirst(key))] = factory;
    };
    return Symbols;
