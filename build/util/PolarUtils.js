...
var formatAxisMap = function (props, axisMap, offset, axisType, chartName) {
    ...
    var cx = (0, DataUtils_1.getPercentValue)(props.cx, width, width / 2);
    var cy = (0, DataUtils_1.getPercentValue)(props.cy, height, height / 2);
    var maxRadius = (0, exports.getMaxRadius)(width, height, offset);
    var innerRadius = (0, DataUtils_1.getPercentValue)(props.innerRadius, maxRadius, 0);
    var outerRadius = (0, DataUtils_1.getPercentValue)(props.outerRadius, maxRadius, maxRadius * 0.8);
    ...
    return ids.reduce(function (result, id) {
        ...
        var _b = (0, ChartUtils_1.parseScale)(axis, chartName), realScaleType = _b.realScaleType, scale = _b.scale;
        scale.domain(domain).range(range);
        (0, ChartUtils_1.checkDomainOfScale)(scale);
        var ticks = (0, ChartUtils_1.getTicksOfScale)(scale, __assign(__assign({}, axis), { realScaleType: realScaleType }));
        var finalAxis = __assign(__assign(__assign({}, axis), ticks), { range: range, radius: outerRadius, realScaleType: realScaleType, scale: scale, cx: cx, cy: cy, innerRadius: innerRadius, outerRadius: outerRadius, startAngle: startAngle, endAngle: endAngle });
...
var getAngleOfPoint = function (_a, _b) {
    ...
    var radius = (0, exports.distanceBetweenPoints)({ x: x, y: y }, { x: cx, y: cy });
    if (radius <= 0) {
    ...
    return { radius: radius, angle: (0, exports.radianToDegree)(angleInRadian), angleInRadian: angleInRadian };
};
...
var inRangeOfSector = function (_a, sector) {
    var x = _a.x, y = _a.y;
    var _b = (0, exports.getAngleOfPoint)({ x: x, y: y }, sector), radius = _b.radius, angle = _b.angle;
    ...
    var _c = (0, exports.formatAngleOfSector)(sector), startAngle = _c.startAngle, endAngle = _c.endAngle;
