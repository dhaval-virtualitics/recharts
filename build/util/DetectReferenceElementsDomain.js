...
var detectReferenceElementsDomain = function (children, domain, axisId, axisType, specifiedTicks) {
    var lines = (0, ReactUtils_1.findAllByType)(children, ReferenceLine_1.ReferenceLine.displayName);
    var dots = (0, ReactUtils_1.findAllByType)(children, ReferenceDot_1.ReferenceDot.displayName);
    var elements = lines.concat(dots);
    var areas = (0, ReactUtils_1.findAllByType)(children, ReferenceArea_1.ReferenceArea.displayName);
    var idKey = "".concat(axisType, "Id");
    var valueKey = axisType[0];
    var finalDomain = domain;
    if (elements.length) {
        finalDomain = elements.reduce(function (result, el) {
            if (el.props[idKey] === axisId && (0, IfOverflowMatches_1.ifOverflowMatches)(el.props, 'extendDomain') && (0, DataUtils_1.isNumber)(el.props[valueKey])) {
    ...
    if (areas.length) {
        var key1_1 = "".concat(valueKey, "1");
        var key2_1 = "".concat(valueKey, "2");
        finalDomain = areas.reduce(function (result, el) {
            if (el.props[idKey] === axisId &&
                (0, IfOverflowMatches_1.ifOverflowMatches)(el.props, 'extendDomain') &&
                (0, DataUtils_1.isNumber)(el.props[key1_1]) &&
                (0, DataUtils_1.isNumber)(el.props[key2_1])) {
