...
var Funnel = (function (_super) {
    ...
    Funnel.prototype.renderTrapezoidsStatically = function (trapezoids) {
        ...
        return trapezoids.map(function (entry, i) {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-funnel-trapezoid" }, (0, types_1.adaptEventsOfChild)(_this.props, entry, i), { key: "trapezoid-".concat(i), role: "img" }), Funnel.renderTrapezoidItem(trapezoidOptions, trapezoidProps)));
        });
    };
    Funnel.prototype.renderTrapezoidsWithAnimation = function () {
        ...
        return (react_1.default.createElement(react_smooth_1.default, { begin: animationBegin, duration: animationDuration, isActive: isAnimationActive, easing: animationEasing, from: { t: 0 }, to: { t: 1 }, key: "funnel-".concat(animationId), onAnimationStart: this.handleAnimationStart, onAnimationEnd: this.handleAnimationEnd }, function (_a) {
            var t = _a.t;
            var stepData = trapezoids.map(function (entry, index) {
                var prev = prevTrapezoids && prevTrapezoids[index];
                if (prev) {
                    var interpolatorX_1 = (0, DataUtils_1.interpolateNumber)(prev.x, entry.x);
                    var interpolatorY_1 = (0, DataUtils_1.interpolateNumber)(prev.y, entry.y);
                    var interpolatorUpperWidth_1 = (0, DataUtils_1.interpolateNumber)(prev.upperWidth, entry.upperWidth);
                    var interpolatorLowerWidth_1 = (0, DataUtils_1.interpolateNumber)(prev.lowerWidth, entry.lowerWidth);
                    var interpolatorHeight_1 = (0, DataUtils_1.interpolateNumber)(prev.height, entry.height);
                ...
                var interpolatorX = (0, DataUtils_1.interpolateNumber)(entry.x + entry.upperWidth / 2, entry.x);
                var interpolatorY = (0, DataUtils_1.interpolateNumber)(entry.y + entry.height / 2, entry.y);
                var interpolatorUpperWidth = (0, DataUtils_1.interpolateNumber)(0, entry.upperWidth);
                var interpolatorLowerWidth = (0, DataUtils_1.interpolateNumber)(0, entry.lowerWidth);
    ...
    Funnel.prototype.render = function () {
        ...
        var layerClass = (0, classnames_1.default)('recharts-trapezoids', className);
    ...
    Funnel.getComposedData = function (_a) {
        ...
        var maxValue = Math.max.apply(null, funnelData.map(function (entry) { return (0, ChartUtils_1.getValueByDataKey)(entry, dataKey, 0); }));
        ...
        var trapezoids = funnelData.map(function (entry, i) {
            var _a;
            var rawVal = (0, ChartUtils_1.getValueByDataKey)(entry, dataKey, 0);
            ...
            return __assign(__assign({ x: x, y: y, width: Math.max(upperWidth, lowerWidth), upperWidth: upperWidth, lowerWidth: lowerWidth, height: rowHeight, name: name, val: val, tooltipPayload: tooltipPayload, tooltipPosition: tooltipPosition }, lodash_1.default.omit(entry, 'width')), { payload: entry, parentViewBox: parentViewBox, labelViewBox: {
