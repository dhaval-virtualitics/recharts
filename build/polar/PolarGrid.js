...
var PolarGrid = (function (_super) {
    ...
    PolarGrid.prototype.getPolygonPath = function (radius) {
        ...
        polarAngles.forEach(function (angle, i) {
            var point = (0, PolarUtils_1.polarToCartesian)(cx, cy, radius, angle);
            if (i) {
    ...
    PolarGrid.prototype.renderPolarAngles = function () {
        ...
        var props = __assign({ stroke: '#ccc' }, (0, types_1.filterProps)(this.props));
        return (react_1.default.createElement("g", { className: "recharts-polar-grid-angle" }, polarAngles.map(function (entry, i) {
            var start = (0, PolarUtils_1.polarToCartesian)(cx, cy, innerRadius, entry);
            var end = (0, PolarUtils_1.polarToCartesian)(cx, cy, outerRadius, entry);
            return (react_1.default.createElement("line", __assign({}, props, { key: "line-".concat(i), x1: start.x, y1: start.y, x2: end.x, y2: end.y })));
        })));
    };
    PolarGrid.prototype.renderConcentricCircle = function (radius, index, extraProps) {
        var _a = this.props, cx = _a.cx, cy = _a.cy;
        var props = __assign(__assign(__assign({ stroke: '#ccc' }, (0, types_1.filterProps)(this.props)), { fill: 'none' }), extraProps);
        return (react_1.default.createElement("circle", __assign({}, props, { className: "recharts-polar-grid-concentric-circle", key: "circle-".concat(index), cx: cx, cy: cy, r: radius })));
    };
    PolarGrid.prototype.renderConcentricPolygon = function (radius, index, extraProps) {
        var props = __assign(__assign(__assign({ stroke: '#ccc' }, (0, types_1.filterProps)(this.props)), { fill: 'none' }), extraProps);
        return (react_1.default.createElement("path", __assign({}, props, { className: "recharts-polar-grid-concentric-polygon", key: "path-".concat(index), d: this.getPolygonPath(radius) })));
    };
