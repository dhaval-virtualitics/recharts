...
var PolarRadiusAxis = (function (_super) {
    ...
    PolarRadiusAxis.prototype.renderAxisLine = function () {
        ...
        var point0 = (0, PolarUtils_1.polarToCartesian)(cx, cy, extent[0], angle);
        var point1 = (0, PolarUtils_1.polarToCartesian)(cx, cy, extent[1], angle);
        var props = __assign(__assign(__assign(__assign({}, (0, types_1.filterProps)(others)), { fill: 'none' }), (0, types_1.filterProps)(axisLine)), { x1: point0.x, y1: point0.y, x2: point1.x, y2: point1.y });
    ...
    PolarRadiusAxis.prototype.renderTicks = function () {
        ...
        var axisProps = (0, types_1.filterProps)(others);
        var customTickProps = (0, types_1.filterProps)(tick);
        var items = ticks.map(function (entry, i) {
            var coord = _this.getTickValueCoord(entry);
            var tickProps = __assign(__assign(__assign(__assign(__assign(__assign({ textAnchor: textAnchor, transform: "rotate(".concat(90 - angle, ", ").concat(coord.x, ", ").concat(coord.y, ")") }, axisProps), { stroke: 'none', fill: stroke }), customTickProps), { index: i }), coord), { payload: entry });
            return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-polar-radius-axis-tick", key: "tick-".concat(i) }, (0, types_1.adaptEventsOfChild)(_this.props, entry, i)), PolarRadiusAxis.renderTickItem(tick, tickProps, tickFormatter ? tickFormatter(entry.value, i) : entry.value)));
        });
