...
var Radar = (function (_super) {
    ...
    Radar.prototype.renderDots = function (points) {
        ...
        var customDotProps = (0, types_1.filterProps)(dot);
        var dots = points.map(function (entry, i) {
            var dotProps = __assign(__assign(__assign({ key: "dot-".concat(i), r: 3 }, baseProps), customDotProps), { dataKey: dataKey, cx: entry.x, cy: entry.y, index: i, payload: entry });
    ...
    Radar.prototype.renderPolygonStatically = function (points) {
        ...
        if (react_1.default.isValidElement(shape)) {
            ...
            radar = (react_1.default.createElement(Polygon_1.Polygon, __assign({}, (0, types_1.filterProps)(this.props, true), { onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, points: points, baseLinePoints: isRange ? baseLinePoints : null, connectNulls: connectNulls })));
        }
    ...
    Radar.prototype.renderPolygonWithAnimation = function () {
        ...
        return (react_1.default.createElement(react_smooth_1.default, { begin: animationBegin, duration: animationDuration, isActive: isAnimationActive, easing: animationEasing, from: { t: 0 }, to: { t: 1 }, key: "radar-".concat(animationId), onAnimationEnd: this.handleAnimationEnd, onAnimationStart: this.handleAnimationStart }, function (_a) {
            var t = _a.t;
            ...
            var stepData = points.map(function (entry, index) {
                ...
                var interpolatorX = (0, DataUtils_1.interpolateNumber)(entry.cx, entry.x);
                var interpolatorY = (0, DataUtils_1.interpolateNumber)(entry.cy, entry.y);
    ...
    Radar.prototype.render = function () {
        ...
        var layerClass = (0, classnames_1.default)('recharts-radar', className);
    ...
    Radar.getComposedData = function (_a) {
        ...
        displayedData.forEach(function (entry, i) {
            var name = (0, ChartUtils_1.getValueByDataKey)(entry, angleAxis.dataKey, i);
            ...
            points.push(__assign(__assign({}, (0, PolarUtils_1.polarToCartesian)(cx, cy, radius, angle)), { name: name, value: value, cx: cx, cy: cy, radius: radius, angle: angle, payload: entry }));
        });
        var baseLinePoints = [];
        if (isRange) {
            points.forEach(function (point) {
                if (lodash_1.default.isArray(point.value)) {
                    ...
                    baseLinePoints.push(__assign(__assign(__assign({}, point), { radius: radius }), (0, PolarUtils_1.polarToCartesian)(cx, cy, radius, point.angle)));
                }
                else {
