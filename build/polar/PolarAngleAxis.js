...
var PolarAngleAxis = (function (_super) {
    ...
    PolarAngleAxis.prototype.getTickLineCoord = function (data) {
        ...
        var p1 = (0, PolarUtils_1.polarToCartesian)(cx, cy, radius, data.coordinate);
        var p2 = (0, PolarUtils_1.polarToCartesian)(cx, cy, radius + (orientation === 'inner' ? -1 : 1) * tickLineSize, data.coordinate);
    ...
    PolarAngleAxis.prototype.renderAxisLine = function () {
        ...
        var props = __assign(__assign(__assign({}, (0, types_1.filterProps)(this.props)), { fill: 'none' }), (0, types_1.filterProps)(axisLine));
        ...
        var points = ticks.map(function (entry) { return (0, PolarUtils_1.polarToCartesian)(cx, cy, radius, entry.coordinate); });
    ...
    PolarAngleAxis.prototype.renderTicks = function () {
        ...
        var items = ticks.map(function (entry, i) {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-polar-angle-axis-tick", key: "tick-".concat(i) }, (0, types_1.adaptEventsOfChild)(_this.props, entry, i)),
