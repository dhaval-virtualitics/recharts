...
var calculateWordWidths = function (props) {
    try {
        ...
        var wordsWithComputedWidth = words.map(function (word) { return ({ word: word, width: (0, DOMUtils_1.getStringSize)(word, props.style).width }); });
        var spaceWidth = props.breakAll ? 0 : (0, DOMUtils_1.getStringSize)('\u00A0', props.style).width;
...
var calculateWordsByLines = function (props, initialWordsWithComputedWith, spaceWidth, lineWidth, scaleToFit) {
    var shouldLimitLines = (0, DataUtils_1.isNumber)(props.maxLines);
...
var Text = (function (_super) {
    ...
    Text.prototype.render = function () {
        ...
        if (!(0, DataUtils_1.isNumOrStr)(textProps.x) || !(0, DataUtils_1.isNumOrStr)(textProps.y)) {
            return null;
        }
        var x = textProps.x + ((0, DataUtils_1.isNumber)(dx) ? dx : 0);
        var y = textProps.y + ((0, DataUtils_1.isNumber)(dy) ? dy : 0);
        var startDy;
        switch (verticalAnchor) {
            case 'start':
                startDy = (0, reduce_css_calc_1.default)("calc(".concat(capHeight, ")"));
                break;
            case 'middle':
                startDy = (0, reduce_css_calc_1.default)("calc(".concat((wordsByLines.length - 1) / 2, " * -").concat(lineHeight, " + (").concat(capHeight, " / 2))"));
                break;
            default:
                startDy = (0, reduce_css_calc_1.default)("calc(".concat(wordsByLines.length - 1, " * -").concat(lineHeight, ")"));
                break;
        }
        var transforms = [];
        if (scaleToFit) {
            ...
            transforms.push("scale(".concat(((0, DataUtils_1.isNumber)(width) ? width / lineWidth : 1) / lineWidth, ")"));
        }
        if (angle) {
        ...
        return (react_1.default.createElement("text", __assign({}, (0, types_1.filterProps)(textProps, true), { x: x, y: y, className: (0, classnames_1.default)('recharts-text', className), textAnchor: textAnchor, fill: textProps.fill.includes('url') ? Text.defaultProps.fill : textProps.fill }), wordsByLines.map(function (line, index) { return (react_1.default.createElement("tspan", { x: x, dy: index === 0 ? startDy : lineHeight, key: index }, line.words.join(breakAll ? '' : ' '))); })));
    };
    Text.defaultProps = {
        x: 0,
        y: 0,
