...
var Tooltip = (function (_super) {
    ...
    function Tooltip() {
        ...
        _this.getTranslate = function (_a) {
            ...
            var _b = _this.props, allowEscapeViewBox = _b.allowEscapeViewBox, reverseDirection = _b.reverseDirection, coordinate = _b.coordinate, offset = _b.offset, position = _b.position, viewBox = _b.viewBox;
    ...
    Tooltip.prototype.updateBBox = function () {
        var _a = this.state, boxWidth = _a.boxWidth, boxHeight = _a.boxHeight, dismissed = _a.dismissed;
        if (dismissed) {
            this.wrapperNode.blur();
            if (this.props.coordinate.x !== this.state.dismissedAtCoordinate.x ||
    ...
    Tooltip.prototype.render = function () {
        ...
        var outerStyle = __assign({ pointerEvents: 'none', visibility: !this.state.dismissed && active && hasPayload ? 'visible' : 'hidden', position: 'absolute', top: 0, left: 0 }, wrapperStyle);
        var translateX, translateY;
        if (position && (0, DataUtils_1.isNumber)(position.x) && (0, DataUtils_1.isNumber)(position.y)) {
        ...
        var cls = (0, classnames_1.default)(CLS_PREFIX, (_a = {},
            _a["".concat(CLS_PREFIX, "-right")] = (0, DataUtils_1.isNumber)(translateX) && coordinate && (0, DataUtils_1.isNumber)(coordinate.x) && translateX >= coordinate.x,
            _a["".concat(CLS_PREFIX, "-left")] = (0, DataUtils_1.isNumber)(translateX) && coordinate && (0, DataUtils_1.isNumber)(coordinate.x) && translateX < coordinate.x,
            _a["".concat(CLS_PREFIX, "-bottom")] = (0, DataUtils_1.isNumber)(translateY) && coordinate && (0, DataUtils_1.isNumber)(coordinate.y) && translateY >= coordinate.y,
            _a["".concat(CLS_PREFIX, "-top")] = (0, DataUtils_1.isNumber)(translateY) && coordinate && (0, DataUtils_1.isNumber)(coordinate.y) && translateY < coordinate.y,
            _a));
        return (react_1.default.createElement("div", { tabIndex: -1, role: "dialog", onKeyDown: function (event) {
                if (event.key === 'Escape') {
                    _this.setState({
                        dismissed: true,
                        dismissedAtCoordinate: __assign(__assign({}, _this.state.dismissedAtCoordinate), { x: _this.props.coordinate.x, y: _this.props.coordinate.y }),
                    });
                }
            }, className: cls, style: outerStyle, ref: function (node) {
