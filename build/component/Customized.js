...
function Customized(_a) {
    ...
    if ((0, react_1.isValidElement)(component)) {
        child = (0, react_1.cloneElement)(component, props);
    }
    else if (lodash_1.default.isFunction(component)) {
        child = (0, react_1.createElement)(component, props);
    }
    else {
        (0, LogUtils_1.warn)(false, "Customized's props `component` must be React.element or Function, but got %s.", typeof component);
    }
