...
var DefaultLegendContent = (function (_super) {
    ...
    DefaultLegendContent.prototype.renderIcon = function (data) {
        ...
        if (data.type === 'line') {
            return (react_1.default.createElement("path", { strokeWidth: 4, fill: "none", stroke: color, d: "M0,".concat(halfSize, "h").concat(thirdSize, "\n            A").concat(sixthSize, ",").concat(sixthSize, ",0,1,1,").concat(2 * thirdSize, ",").concat(halfSize, "\n            H").concat(SIZE, "M").concat(2 * thirdSize, ",").concat(halfSize, "\n            A").concat(sixthSize, ",").concat(sixthSize, ",0,1,1,").concat(thirdSize, ",").concat(halfSize), className: "recharts-legend-icon" }));
        }
        if (data.type === 'rect') {
            return (react_1.default.createElement("path", { stroke: "none", fill: color, d: "M0,".concat(SIZE / 8, "h").concat(SIZE, "v").concat((SIZE * 3) / 4, "h").concat(-SIZE, "z"), className: "recharts-legend-icon" }));
        }
    ...
    DefaultLegendContent.prototype.renderItems = function () {
        ...
        return payload.map(function (entry, i) {
            ...
            return (react_1.default.createElement("li", __assign({ className: className, style: itemStyle, key: "legend-item-".concat(i) }, (0, types_1.adaptEventsOfChild)(_this.props, entry, i)),
