...
function defaultFormatter(value) {
    return lodash_1.default.isArray(value) && (0, DataUtils_1.isNumOrStr)(value[0]) && (0, DataUtils_1.isNumOrStr)(value[1]) ? value.join(' ~ ') : value;
}
var DefaultTooltipContent = (function (_super) {
            ...
            var items = (itemSorter ? lodash_1.default.sortBy(payload, itemSorter) : payload).map(function (entry, i) {
                ...
                if (finalFormatter && value != null && name != null) {
                    ...
                    if (Array.isArray(formatted)) {
                        _a = formatted, value = _a[0], name = _a[1];
                    }
                    else {
                        value = formatted;
                    }
                }
                return (react_1.default.createElement("li", { className: "recharts-tooltip-item", key: "tooltip-item-".concat(i), style: finalItemStyle },
                    (0, DataUtils_1.isNumOrStr)(name) ? react_1.default.createElement("span", { className: "recharts-tooltip-item-name" }, name) : null,
                    (0, DataUtils_1.isNumOrStr)(name) ? react_1.default.createElement("span", { className: "recharts-tooltip-item-separator" }, separator) : null,
    ...
    DefaultTooltipContent.prototype.render = function () {
        ...
        var wrapperCN = (0, classnames_1.default)('recharts-default-tooltip', wrapperClassName);
        var labelCN = (0, classnames_1.default)('recharts-tooltip-label', labelClassName);
        if (hasLabel && labelFormatter && payload !== undefined && payload !== null) {
            finalLabel = labelFormatter(label, payload);
        }
        return (react_1.default.createElement("div", { className: wrapperCN, style: finalStyle },
            react_1.default.createElement("p", { className: labelCN, style: finalLabelStyle }, react_1.default.isValidElement(finalLabel) ? finalLabel : "".concat(finalLabel)),
            this.renderContent()));
    };
