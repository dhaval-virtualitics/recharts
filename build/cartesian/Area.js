...
var Area = (function (_super) {
    ...
    function Area() {
        ...
        _this.id = (0, DataUtils_1.uniqueId)('recharts-area-');
    ...
    Area.prototype.renderDots = function (needClip, clipPathId) {
        ...
        var areaProps = (0, types_1.filterProps)(this.props);
        var customDotProps = (0, types_1.filterProps)(dot, true);
        var dots = points.map(function (entry, i) {
            var dotProps = __assign(__assign(__assign({ key: "dot-".concat(i), r: 3 }, areaProps), customDotProps), { dataKey: dataKey, cx: entry.x, cy: entry.y, index: i, value: entry.value, payload: entry.payload });
    ...
    Area.prototype.renderHorizontalRect = function (alpha) {
        ...
        if ((0, DataUtils_1.isNumber)(maxY)) {
            return (react_1.default.createElement("rect", { x: startX < endX ? startX : startX - width, y: 0, width: width, height: Math.floor(maxY + (strokeWidth ? parseInt("".concat(strokeWidth), 10) : 1)) }));
        }
        return null;
    };
    Area.prototype.renderVerticalRect = function (alpha) {
        ...
        if ((0, DataUtils_1.isNumber)(maxX)) {
            return (react_1.default.createElement("rect", { x: 0, y: startY < endY ? startY : startY - height, width: maxX + (strokeWidth ? parseInt("".concat(strokeWidth), 10) : 1), height: Math.floor(height) }));
        }
        return null;
    };
    ...
    Area.prototype.renderAreaStatically = function (points, baseLine, needClip, clipPathId) {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null },
            react_1.default.createElement(Curve_1.Curve, __assign({}, (0, types_1.filterProps)(others, true), { points: points, connectNulls: connectNulls, type: type, baseLine: baseLine, layout: layout, stroke: "none", className: "recharts-area-area" })),
            stroke !== 'none' && (react_1.default.createElement(Curve_1.Curve, __assign({}, (0, types_1.filterProps)(this.props), { className: "recharts-area-curve", layout: layout, type: type, connectNulls: connectNulls, fill: "none", points: points }))),
            stroke !== 'none' && isRange && (react_1.default.createElement(Curve_1.Curve, __assign({}, (0, types_1.filterProps)(this.props), { className: "recharts-area-curve", layout: layout, type: type, connectNulls: connectNulls, fill: "none", points: baseLine })))));
    };
    Area.prototype.renderAreaWithAnimation = function (needClip, clipPathId) {
        ...
        return (react_1.default.createElement(react_smooth_1.default, { begin: animationBegin, duration: animationDuration, isActive: isAnimationActive, easing: animationEasing, from: { t: 0 }, to: { t: 1 }, key: "area-".concat(animationId), onAnimationEnd: this.handleAnimationEnd, onAnimationStart: this.handleAnimationStart }, function (_a) {
            var t = _a.t;
            if (prevPoints) {
                ...
                var stepPoints = points.map(function (entry, index) {
                    ...
                    if (prevPoints[prevPointIndex]) {
                        ...
                        var interpolatorX = (0, DataUtils_1.interpolateNumber)(prev.x, entry.x);
                        var interpolatorY = (0, DataUtils_1.interpolateNumber)(prev.y, entry.y);
                ...
                if ((0, DataUtils_1.isNumber)(baseLine) && typeof baseLine === 'number') {
                    var interpolator = (0, DataUtils_1.interpolateNumber)(prevBaseLine, baseLine);
                    stepBaseLine = interpolator(t);
                }
                else if (lodash_1.default.isNil(baseLine) || lodash_1.default.isNaN(baseLine)) {
                    var interpolator = (0, DataUtils_1.interpolateNumber)(prevBaseLine, 0);
                    stepBaseLine = interpolator(t);
                }
                else {
            ...
            return (react_1.default.createElement(Layer_1.Layer, null,
                react_1.default.createElement("defs", null,
                    react_1.default.createElement("clipPath", { id: "animationClipPath-".concat(clipPathId) }, _this.renderClipRect(t))),
                react_1.default.createElement(Layer_1.Layer, { clipPath: "url(#animationClipPath-".concat(clipPathId, ")") }, _this.renderAreaStatically(points, baseLine, needClip, clipPathId))));
        }));
    };
    ...
    Area.prototype.render = function () {
        ...
        var layerClass = (0, classnames_1.default)('recharts-area', className);
        ...
        return (react_1.default.createElement(Layer_1.Layer, { className: layerClass },
            needClip ? (react_1.default.createElement("defs", null,
                react_1.default.createElement("clipPath", { id: "clipPath-".concat(clipPathId) },
    ...
    Area.getComposedData = function (_a) {
        var props = _a.props, item = _a.item, xAxis = _a.xAxis, yAxis = _a.yAxis, xAxisTicks = _a.xAxisTicks, yAxisTicks = _a.yAxisTicks, bandSize = _a.bandSize, dataKey = _a.dataKey, stackedData = _a.stackedData, dataStartIndex = _a.dataStartIndex, displayedData = _a.displayedData, offset = _a.offset;
        var layout = props.layout;
        var hasStack = stackedData && stackedData.length;
        var baseValue = Area.getBaseValue(props, item, xAxis, yAxis);
        var isRange = false;
        var points = displayedData.map(function (entry, index) {
            var originalValue = (0, ChartUtils_1.getValueByDataKey)(entry, dataKey);
            var value;
            if (hasStack) {
            ...
            if (layout === 'horizontal') {
                return {
                    x: (0, ChartUtils_1.getCateCoordinateOfLine)({ axis: xAxis, ticks: xAxisTicks, bandSize: bandSize, entry: entry, index: index }),
            ...
            return {
                ...
                y: (0, ChartUtils_1.getCateCoordinateOfLine)({ axis: yAxis, ticks: yAxisTicks, bandSize: bandSize, entry: entry, index: index }),
                value: value,
                payload: entry,
            };
        });
