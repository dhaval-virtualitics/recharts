...
var CartesianGrid = (function (_super) {
    ...
    CartesianGrid.renderLineItem = function (option, props) {
        ...
        if (react_1.default.isValidElement(option)) {
            ...
            lineItem = react_1.default.createElement("line", __assign({}, (0, types_1.filterProps)(others), { x1: x1, y1: y1, x2: x2, y2: y2, fill: "none", key: key }));
        }
        return lineItem;
    };
    CartesianGrid.prototype.renderHorizontal = function (horizontalPoints) {
        ...
        var items = horizontalPoints.map(function (entry, i) {
            var props = __assign(__assign({}, _this.props), { x1: x, y1: entry, x2: x + width, y2: entry, key: "line-".concat(i), index: i });
    ...
    CartesianGrid.prototype.renderVertical = function (verticalPoints) {
        ...
        var items = verticalPoints.map(function (entry, i) {
            var props = __assign(__assign({}, _this.props), { x1: entry, y1: y, x2: entry, y2: y + height, key: "line-".concat(i), index: i });
    ...
    CartesianGrid.prototype.renderVerticalStripes = function (verticalPoints) {
        ...
        var roundedSortedVerticalPoints = verticalPoints.map(function (e) { return Math.round(e + x - x); }).sort(function (a, b) { return a - b; });
        ...
        var items = roundedSortedVerticalPoints.map(function (entry, i) {
            ...
            return (react_1.default.createElement("rect", { key: "react-".concat(i), x: entry, y: y, width: lineWidth, height: height, stroke: "none", fill: verticalFill[colorIndex], fillOpacity: fillOpacity, className: "recharts-cartesian-grid-bg" }));
        });
    ...
    CartesianGrid.prototype.renderHorizontalStripes = function (horizontalPoints) {
        ...
        var _a = this.props, fillOpacity = _a.fillOpacity, x = _a.x, y = _a.y, width = _a.width, height = _a.height;
        var roundedSortedHorizontalPoints = horizontalPoints.map(function (e) { return Math.round(e + y - y); }).sort(function (a, b) { return a - b; });
        ...
        var items = roundedSortedHorizontalPoints.map(function (entry, i) {
            ...
            return (react_1.default.createElement("rect", { key: "react-".concat(i), y: entry, x: x, height: lineHeight, width: width, stroke: "none", fill: horizontalFill[colorIndex], fillOpacity: fillOpacity, className: "recharts-cartesian-grid-bg" }));
        });
