...
var CartesianAxis = (function (_super) {
    ...
    CartesianAxis.getTicks = function (props, fontSize, letterSpacing) {
        ...
        if ((0, DataUtils_1.isNumber)(interval) || Global_1.Global.isSsr) {
            return CartesianAxis.getNumberIntervalTicks(ticks, typeof interval === 'number' && (0, DataUtils_1.isNumber)(interval) ? interval : 0);
        }
    ...
    CartesianAxis.getTicksStart = function (_a, preserveEnd) {
        var ticks = _a.ticks, tickFormatter = _a.tickFormatter, viewBox = _a.viewBox, orientation = _a.orientation, minTickGap = _a.minTickGap, unit = _a.unit, fontSize = _a.fontSize, letterSpacing = _a.letterSpacing;
        var x = viewBox.x, y = viewBox.y, width = viewBox.width, height = viewBox.height;
        var sizeKey = orientation === 'top' || orientation === 'bottom' ? 'width' : 'height';
        var result = (ticks || []).slice();
        var unitSize = unit && sizeKey === 'width' ? (0, DOMUtils_1.getStringSize)(unit, { fontSize: fontSize, letterSpacing: letterSpacing })[sizeKey] : 0;
        var len = result.length;
        var sign = len >= 2 ? (0, DataUtils_1.mathSign)(result[1].coordinate - result[0].coordinate) : 1;
        var start, end;
        if (sign === 1) {
        ...
        if (preserveEnd) {
            ...
            var tailSize = (0, DOMUtils_1.getStringSize)(tailContent, { fontSize: fontSize, letterSpacing: letterSpacing })[sizeKey] + unitSize;
        ...
        for (var i = 0; i < count; i++) {
            ...
            var size = (0, DOMUtils_1.getStringSize)(content, { fontSize: fontSize, letterSpacing: letterSpacing })[sizeKey] + unitSize;
            if (i === 0) {
    ...
    CartesianAxis.prototype.getTickLineCoord = function (data) {
        ...
        var tickCoord = (0, DataUtils_1.isNumber)(data.tickCoord) ? data.tickCoord : data.coordinate;
        switch (orientation) {
            case 'top':
    ...
    CartesianAxis.prototype.renderAxisLine = function () {
        ...
        var props = __assign(__assign(__assign({}, (0, types_1.filterProps)(this.props)), (0, types_1.filterProps)(axisLine)), { fill: 'none' });
        ...
        return react_1.default.createElement("line", __assign({}, props, { className: (0, classnames_1.default)('recharts-cartesian-axis-line', lodash_1.default.get(axisLine, 'className')) }));
    };
    ...
    CartesianAxis.prototype.renderTicks = function (ticks, fontSize, letterSpacing) {
        ...
        var finalTicks = CartesianAxis.getTicks(__assign(__assign({}, this.props), { ticks: ticks }), fontSize, letterSpacing);
        var textAnchor = this.getTickTextAnchor();
        var verticalAnchor = this.getTickVerticalAnchor();
        var axisProps = (0, types_1.filterProps)(this.props);
        var customTickProps = (0, types_1.filterProps)(tick);
        var tickLineProps = __assign(__assign(__assign({}, axisProps), { fill: 'none' }), (0, types_1.filterProps)(tickLine));
        var items = finalTicks.map(function (entry, i) {
            var _a = _this.getTickLineCoord(entry), lineCoord = _a.line, tickCoord = _a.tick;
            var tickProps = __assign(__assign(__assign(__assign(__assign({ textAnchor: textAnchor, verticalAnchor: verticalAnchor }, axisProps), { stroke: 'none', fill: stroke }), customTickProps), tickCoord), { index: i, payload: entry, visibleTicksCount: finalTicks.length, tickFormatter: tickFormatter });
            return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-cartesian-axis-tick", key: "tick-".concat(i) }, (0, types_1.adaptEventsOfChild)(_this.props, entry, i)),
                tickLine && (react_1.default.createElement("line", __assign({}, tickLineProps, lineCoord, { className: (0, classnames_1.default)('recharts-cartesian-axis-tick-line', lodash_1.default.get(tickLine, 'className')) }))),
                tick &&
                    CartesianAxis.renderTickItem(tick, tickProps, "".concat(lodash_1.default.isFunction(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || ''))));
        });
    ...
    CartesianAxis.prototype.render = function () {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { className: (0, classnames_1.default)('recharts-cartesian-axis', className), ref: function (ref) {
