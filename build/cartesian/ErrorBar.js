...
function ErrorBar(props) {
    ...
    var svgProps = (0, types_1.filterProps)(others);
    var errorBars = data.map(function (entry, i) {
        ...
        return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-errorBar", key: "bar-".concat(i) }, svgProps), lineCoordinates.map(function (coordinates, index) { return (react_1.default.createElement("line", __assign({}, coordinates, { key: "line-".concat(index) }))); })));
    });
