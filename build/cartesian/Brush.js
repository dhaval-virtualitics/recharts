...
var createScale = function (_a) {
    ...
    var len = data.length;
    var scale = (0, d3_scale_1.scalePoint)()
...
var Brush = (function (_super) {
    ...
    Brush.prototype.getTextOfTick = function (index) {
        ...
        var text = (0, ChartUtils_1.getValueByDataKey)(data[index], dataKey, index);
    ...
    Brush.prototype.renderTravellerLayer = function (travellerX, id) {
        ...
        var travellerProps = __assign(__assign({}, (0, types_1.filterProps)(this.props)), { x: x, y: y, width: travellerWidth, height: height });
    ...
    Brush.prototype.render = function () {
        ...
        var layerClass = (0, classnames_1.default)('recharts-brush', className);
        var isPanoramic = react_1.default.Children.count(children) === 1;
        var style = (0, CssPrefixUtils_1.generatePrefixStyle)('userSelect', 'none');
