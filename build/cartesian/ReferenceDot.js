...
var getCoordinate = function (props) {
    ...
    if ((0, IfOverflowMatches_1.ifOverflowMatches)(props, 'discard') && !scales.isInRange(result)) {
        return null;
    }
    return result;
};
function ReferenceDot(props) {
    ...
    var isX = (0, DataUtils_1.isNumOrStr)(x);
    var isY = (0, DataUtils_1.isNumOrStr)(y);
    ...
    var dotProps = __assign(__assign({ clipPath: clipPath }, (0, types_1.filterProps)(props, true)), { cx: cx, cy: cy });
    return (react_1.default.createElement(Layer_1.Layer, { className: (0, classnames_1.default)('recharts-reference-dot', className) },
