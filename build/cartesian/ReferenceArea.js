...
var getRect = function (hasX1, hasX2, hasY1, hasY2, props) {
    ...
    if ((0, IfOverflowMatches_1.ifOverflowMatches)(props, 'discard') && (!scales.isInRange(p1) || !scales.isInRange(p2))) {
        return null;
    }
...
function ReferenceArea(props) {
    ...
    var hasX1 = (0, DataUtils_1.isNumOrStr)(x1);
    var hasX2 = (0, DataUtils_1.isNumOrStr)(x2);
    var hasY1 = (0, DataUtils_1.isNumOrStr)(y1);
    var hasY2 = (0, DataUtils_1.isNumOrStr)(y2);
    ...
    return (react_1.default.createElement(Layer_1.Layer, { className: (0, classnames_1.default)('recharts-reference-area', className) },
        ReferenceArea.renderRect(shape, __assign(__assign({ clipPath: clipPath }, (0, types_1.filterProps)(props, true)), rect)),
